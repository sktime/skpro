...
# 2. Initialize Model
# Higher noise_precision (beta) makes the model trust data more than the prior
...
print(f"  Uncertainty Reduction: {((sig1_p - sig2_p)/sig1_p)*100:.2f}%")
print("-" * 50)
print(f"Learned Coefficients (Posterior):")
print(f"  Mean Weights:\n{model._coefs_posterior_mu}")
print(f"  Covariance Matrix:\n{model._coefs_posterior_cov}")
print("="*50 + "\n")
