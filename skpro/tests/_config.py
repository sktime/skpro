...
EXCLUDED_TESTS = {
    ...
    # Because the scipy adapter tests compare against the base scipy distribution,
    # these tests should be skipped as it is incorrect for zero-inflated mixtures.
    "ZIPoisson": [
