...
"""Gumbel Left probability distribution."""

from scipy.stats import gumbel_l, rv_continuous

from skpro.distributions.adapters.scipy import _ScipyAdapter

class GumbelL(_ScipyAdapter):
    r"""Gumbel Left probability distribution.

    The Gumbel Left distribution is a continuous probability distribution with two
