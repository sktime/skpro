...
class RiverRegressor(BaseOnlineRegressor):
    ...
    def get_test_params(cls, parameter_set="default"):
        ...
        # LinearRegression supports learn_many/predict_many, while
        # HoeffdingTreeRegressor exercises the learn_one/predict_one fallback
        params1 = {"estimator": linear_model.LinearRegression()}
        params2 = {"estimator": tree.HoeffdingTreeRegressor()}
