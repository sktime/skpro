...
class MapieJackknifeAfterBootstrapRegressor(BaseProbaRegressor):
    ...
    cv : int or Subsample, default=50
        Number of bootstrap resamples or a Subsample instance.
        Higher values (50-100+) recommended for reliable prediction intervals.
    ...
    def get_test_params(cls, parameter_set="default"):
        ...
        # Use cv >= 50 to avoid "at least one point belongs to every resamplings"
        # warning on small test datasets
        params1 = {
